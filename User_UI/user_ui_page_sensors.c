...
void USER_UI_ShowPhotoelectricPageDynamic(void)
{
    ...
    case 1u:
        ...
        break;
    case 2u:
        USER_OLED_PutUI16(2u, 0u, USER_OEMT_GetRawData(0), 4u);
        USER_OLED_PutUI16(2u, 5u, USER_OEMT_GetRawData(1), 4u);
        USER_OLED_PutUI16(2u, 10u, USER_OEMT_GetRawData(2), 4u);
        USER_OLED_PutUI16(2u, 15u, USER_OEMT_GetRawData(3), 4u);
        break;
    case 3u:
        USER_OLED_PutUI16(3u, 0u, USER_OEMT_GetRawData(4), 4u);
        USER_OLED_PutUI16(3u, 5u, USER_OEMT_GetRawData(5), 4u);
        USER_OLED_PutUI16(3u, 10u, USER_OEMT_GetRawData(6), 4u);
        USER_OLED_PutUI16(3u, 15u, USER_OEMT_GetRawData(7), 4u);
        break;
    case 4u:
        USER_OLED_PutUI16(4u, 14u, USER_OEMT_GetScanRate(), 4u);
        break;
    case 5u:
        USER_OLED_PutUI16(5u, 17u, s_photo_selected_channel, 1u);
        break;
    case 6u:
        USER_OLED_PutUI16(6u, 14u, USER_OEMT_GetHysteresisHigh(s_photo_selected_channel), 4u);
        break;
    case 7u:
        USER_OLED_PutUI16(7u, 14u, USER_OEMT_GetHysteresisLow(s_photo_selected_channel), 4u);
        break;
    default:
        break;
    }
...
void USER_UI_PhotoelectricOnKey(Button_t key, USER_UI_KeyEvent_t event)
{
    ...
    case LEFT:
        if ((event == USER_UI_KEY_EVENT_SHORT) || (event == USER_UI_KEY_EVENT_LONG_REPEAT))
        {
            ...
            {
                threshold = USER_OEMT_GetHysteresisLow(s_photo_selected_channel);
                USER_OEMT_SetHysteresisLow(s_photo_selected_channel, (threshold > 50u) ? (uint16_t)(threshold - 50u) : 0u);
            }
            else
            {
                threshold = USER_OEMT_GetHysteresisHigh(s_photo_selected_channel);
                USER_OEMT_SetHysteresisHigh(s_photo_selected_channel, (threshold > 50u) ? (uint16_t)(threshold - 50u) : 0u);
            }
        }
        break;
    case RIGHT:
        if ((event == USER_UI_KEY_EVENT_SHORT) || (event == USER_UI_KEY_EVENT_LONG_REPEAT))
        {
            if (s_photo_selected_threshold == 1u)
            {
                USER_OEMT_SetHysteresisLow(s_photo_selected_channel,
                                              (uint16_t)(USER_OEMT_GetHysteresisLow(s_photo_selected_channel) + 50u));
            }
            else
            {
                USER_OEMT_SetHysteresisHigh(s_photo_selected_channel,
                                               (uint16_t)(USER_OEMT_GetHysteresisHigh(s_photo_selected_channel) + 50u));
            }
        }
        break;
    case UP:
    ...
    case ENTER:
        if (event == USER_UI_KEY_EVENT_SHORT)
        {
            if (s_photo_selected_threshold == 1u)
            {
                USER_OEMT_AutoSetHysteresisLow();
            }
            else
            {
                USER_OEMT_AutoSetHysteresisHigh();
            }
        }
